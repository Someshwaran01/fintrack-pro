    ...
    <>
      {!familyId ? (
        ...
        <div className="max-w-md mx-auto min-h-screen relative flex flex-col pb-safe">
          ...
          {/* Bottom Navigation */}
          <footer className="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-white/90 backdrop-blur-xl border-t border-gray-100 flex justify-around items-center py-4 px-6 z-50 shadow-[0_-10px_40px_rgba(0,0,0,0.04)]" style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}>
            <button
